...
class ConfigBuilder
{
    ...
    public function mergeConfig(SiteConfig $currentConfig, SiteConfig $newConfig)
    {
        ...
        foreach (['title', 'body', 'summary', 'strip', 'strip_id_or_class', 'strip_image_src', 'single_page_link', 'next_page_link', 'date', 'author', 'strip_attr'] as $var) {
    ...
    public function parseLines(array $lines)
    {
        ...
        foreach ($lines as $line) {
            ...
            if (in_array($command, ['title', 'body','summary', 'strip', 'strip_id_or_class', 'strip_image_src', 'single_page_link', 'next_page_link', 'test_url', 'find_string', 'replace_string', 'login_extra_fields', 'native_ad_clue', 'date', 'author', 'strip_attr'], true)) {
